Locales['fr'] = {
  ...
  ['delivered']                       = 'Véhicule ~p~rendu~s~ au concessionnaire',
  ...
  ['paid_rental']                     = 'Vous avez ~p~payé~s~ votre location de véhicule: ~p~$%s~s~',
  ...
  ['sell_menu']                       = 'Appuez sur ~INPUT_CONTEXT~ pour vendre ~y~%s~s~ au prix de ~p~$%s~s~',
  ...
  ['vehicle_set_owned']               = 'Le véhicule ~y~%s~s~ a été attribué à ~p~%s~s~',
  ['vehicle_set_rented']              = 'Le véhicule ~y~%s~s~ a été loué à ~p~%s~s~',
  ['vehicle_sold']                    = 'Véhicule ~p~vendu~s~',
  ['vehicle_sold_for']                = 'the ~p~%s~s~ has been ~y~sold~s~ for ~p~$%s~s~',
  ['vehicle_sold_to']                 = 'Véhicule ~y~%s~s~ vendu à ~p~%s~s~',
