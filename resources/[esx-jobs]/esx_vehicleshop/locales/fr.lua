Locales['fr'] = {
  ...
  ['vehicle_set_owned']               = 'Le véhicule ~y~%s~s~ a été attribué à ~g~%s~s~',
  ['vehicle_set_rented']              = 'Le véhicule ~y~%s~s~ a été loué à ~g~%s~s~',
  ['vehicle_sold']                    = 'Véhicule ~g~vendu~s~',
  ['vehicle_sold_for']                = 'the ~g~%s~s~ has been ~y~sold~s~ for ~g~$%s~s~',
  ['vehicle_sold_to']                 = 'Véhicule ~y~%s~s~ vendu à ~g~%s~s~',
