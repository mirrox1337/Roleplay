Locales['fi'] = {
  ...
  ['vehicle_belongs']         = 'ajoneuvo kilvellä ~y~%s~s~ on nyt ~p~sinun~s~ omistuksessasi',
  ...
  ['delivered']               = 'ajoneuvo on ~p~kuljetettu~s~ myyjälle',
  ...
  ['paid_rental']             = 'sinä ~p~maksoit~s~ ajoneuvon vuokraamisesta: ~p~$%s~s~',
  ...
  ['sell_menu']               = 'paina ~INPUT_CONTEXT~ myydäksesi ~y~%s~s~ hintaan: ~p~$%s~s~',
  ...
  ['vehicle_set_owned']       = 'ajoneuvo ~y~%s~s~ on nyt määritetty henkilölle ~p~%s~s~',
  ['vehicle_set_rented']      = 'ajoneuvo ~y~%s~s~ on nyt vuokrattu henkilölle ~p~%s~s~',
  ['vehicle_sold']            = 'ajoneuvo ~p~myyty~s~',
  ['vehicle_sold_for']        = 'the ~p~%s~s~ has been ~y~sold~s~ for ~p~$%s~s~',
  ['vehicle_sold_to']         = 'ajoneuvo ~y~%s~s~ myyty henkilölle ~p~%s~s~',
  ...
  ['have_withdrawn']          = 'sinä otit ~y~x%s~s~ ~p~%s~s~',
  ['have_deposited']          = 'sinä talletit ~y~x%s~s~ ~p~%s~s~',
