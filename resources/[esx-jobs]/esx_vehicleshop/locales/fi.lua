Locales['fi'] = {
  ...
  ['vehicle_belongs']         = 'ajoneuvo kilvellä ~y~%s~s~ on nyt ~g~sinun~s~ omistuksessasi',
  ...
  ['vehicle_set_owned']       = 'ajoneuvo ~y~%s~s~ on nyt määritetty henkilölle ~g~%s~s~',
  ['vehicle_set_rented']      = 'ajoneuvo ~y~%s~s~ on nyt vuokrattu henkilölle ~g~%s~s~',
  ['vehicle_sold']            = 'ajoneuvo ~g~myyty~s~',
  ['vehicle_sold_for']        = 'the ~g~%s~s~ has been ~y~sold~s~ for ~g~$%s~s~',
  ['vehicle_sold_to']         = 'ajoneuvo ~y~%s~s~ myyty henkilölle ~g~%s~s~',
  ...
  ['have_withdrawn']          = 'sinä otit ~y~x%s~s~ ~g~%s~s~',
