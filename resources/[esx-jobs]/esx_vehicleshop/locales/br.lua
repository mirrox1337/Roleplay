Locales['br'] = {
  ...
  ['delivered']               = 'veículo ~p~entregue~s~ para o revendedor',
  ...
  ['paid_rental']             = 'Você tem ~p~pago~s~ para o seu aluguel de veiculos: ~p~$%s~s~',
  ...
  ['shop_menu']               = 'pressione ~INPUT_CONTEXT~ para acessar o menu ~y~%s~s~ pela quantidade de ~p~$%s~s~',
  ['generic_shopitem']        = '$%s',
  ['vehicle']                 = 'veículo ',
  ...
  ['vehicle_set_owned']       = 'Veículo ~y~%s~s~ foi atribuído a ~p~%s~s~',
  ['vehicle_set_rented']      = 'Veículo ~y~%s~s~ foi alugado para ~p~%s~s~',
  ['vehicle_sold']            = 'Veículo ~p~vendido~s~',
  ['vehicle_sold_for']        = 'the ~p~%s~s~ has been ~y~sold~s~ for ~p~$%s~s~',
  ['vehicle_sold_to']         = 'Veículo ~y~%s~s~ vendido to ~p~%s~s~',
