Locales['br'] = {
  ...
  ['vehicle_set_owned']       = 'Veículo ~y~%s~s~ foi atribuído a ~g~%s~s~',
  ['vehicle_set_rented']      = 'Veículo ~y~%s~s~ foi alugado para ~g~%s~s~',
  ['vehicle_sold']            = 'Veículo ~g~vendido~s~',
  ['vehicle_sold_for']        = 'the ~g~%s~s~ has been ~y~sold~s~ for ~g~$%s~s~',
  ['vehicle_sold_to']         = 'Veículo ~y~%s~s~ vendido to ~g~%s~s~',
