Locales['en'] = {
  ...
  ['vehicle_belongs']         = 'an vehicle with plate ~y~%s~s~ now belongs to ~g~you~s~',
  ...
  ['vehicle_set_owned']       = 'vehicle ~y~%s~s~ has been assigned to ~g~%s~s~',
  ['vehicle_set_rented']      = 'vehicle ~y~%s~s~ has been rented to ~g~%s~s~',
  ['vehicle_sold']            = 'the vehicle has been ~g~sold~s~',
  ['vehicle_sold_for']        = 'the ~g~%s~s~ has been ~y~sold~s~ for ~g~$%s~s~',
  ['vehicle_sold_to']         = 'the vehicle with plate ~y~%s~s~ has been sold to ~g~%s~s~',
