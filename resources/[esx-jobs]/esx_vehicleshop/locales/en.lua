Locales['en'] = {
  ...
  ['vehicle_belongs']         = 'an vehicle with plate ~y~%s~s~ now belongs to ~p~you~s~',
  ...
  ['delivered']               = 'the vehicle has been ~p~delivered~s~ to the dealer',
  ...
  ['paid_rental']             = 'you have ~p~payed~s~ for your vehicle rental: ~p~$%s~s~',
  ...
  ['sell_menu']               = 'press ~INPUT_CONTEXT~ to sell your ~y~%s~s~ for ~p~$%s~s~',
  ...
  ['vehicle_set_owned']       = 'vehicle ~y~%s~s~ has been assigned to ~p~%s~s~',
  ['vehicle_set_rented']      = 'vehicle ~y~%s~s~ has been rented to ~p~%s~s~',
  ['vehicle_sold']            = 'the vehicle has been ~p~sold~s~',
  ['vehicle_sold_for']        = 'the ~p~%s~s~ has been ~y~sold~s~ for ~p~$%s~s~',
  ['vehicle_sold_to']         = 'the vehicle with plate ~y~%s~s~ has been sold to ~p~%s~s~',
  ...
  ['have_withdrawn']          = 'you have withdrawn ~y~x%s~s~ ~p~%s~s~',
  ['have_deposited']          = 'you have deposited ~y~x%s~s~ ~p~%s~s~',
