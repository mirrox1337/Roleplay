Locales['sv'] = {
  ...
  ['vehicle_belongs']         = 'fordonet med reg numret ~y~%s~s~ tillhör nu ~p~dig~s~',
  ...
  ['delivered']               = 'fordonet har ~p~lämnats tillbaka~s~ till bilförsäljaren',
  ...
  ['paid_rental']             = 'du har ~y~betalat~s~ ditt hyrda fordon: ~p~%s SEK~s~',
  ...
  ['sell_menu']               = 'tryck ~INPUT_CONTEXT~ för att sälja ~y~%s~s~ för ~p~%s SEK~s~',
  ...
  ['vehicle_set_owned']       = 'fordonet ~y~%s~s~ har tilldelats till ~p~%s~s~',
  ['vehicle_set_rented']      = 'fordonet ~y~%s~s~ har hyrts ut till ~p~%s~s~',
  ['vehicle_sold']            = 'fordonet har ~p~sålts~s~',
  ['vehicle_sold_for']        = '~p~%s~s~ har ~y~sålts~s~ för ~p~%s SEK~s~',
  ['vehicle_sold_to']         = '~y~%s~s~ har sålts till ~p~%s~s~',
  ...
  ['have_deposited']          = 'du har lagt in ~y~x%s~s~ ~p~%s~s~',
