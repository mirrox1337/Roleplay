Locales['sv'] = {
  ...
  ['vehicle_belongs']         = 'fordonet med reg numret ~y~%s~s~ tillhör nu ~g~dig~s~',
  ...
  ['vehicle_set_owned']       = 'fordonet ~y~%s~s~ har tilldelats till ~g~%s~s~',
  ['vehicle_set_rented']      = 'fordonet ~y~%s~s~ har hyrts ut till ~g~%s~s~',
  ['vehicle_sold']            = 'fordonet har ~g~sålts~s~',
  ['vehicle_sold_for']        = '~g~%s~s~ har ~y~sålts~s~ för ~g~%s SEK~s~',
  ['vehicle_sold_to']         = '~y~%s~s~ har sålts till ~g~%s~s~',
  ...
  ['have_deposited']          = 'du har lagt in ~y~x%s~s~ ~g~%s~s~',
