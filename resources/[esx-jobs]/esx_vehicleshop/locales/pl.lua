Locales['pl'] = {
  ...
  ['vehicle_belongs']         = 'pojazd z rejestracją ~y~%s~s~ teraz należy do ~g~ciebie~s~',
  ...
  ['vehicle_set_owned']       = 'pojazd ~y~%s~s~ został zarejestrowany na ~g~%s~s~',
  ['vehicle_set_rented']      = 'pojazd ~y~%s~s~ został wynajęty przez ~g~%s~s~',
  ['vehicle_sold']            = 'pojazd został ~g~sprzedany~s~',
  ['vehicle_sold_to']         = 'pojazd ~y~%s~s~ został sprzedany do ~g~%s~s~',
  ...
  ['have_withdrawn']          = 'wyciągasz ~y~x%s~s~ ~g~%s~s~',
  ['have_deposited']          = 'deponujesz ~y~x%s~s~ ~g~%s~s~',
