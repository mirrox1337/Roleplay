Locales['sv'] = {
  ...
  ['customer_found'] = 'du har ~p~hittat~s~ en kund!',
  ['client_unconcious'] = 'din kund är ~r~medvetslös~s~. Hitta en ny.',
  ['arrive_dest'] = 'du har ~p~anlänt~s~ till din destination',
  ...
  ['must_in_vehicle'] = 'du måste vara i ett ~p~fordon~s~ för att starta uppdraget.',
  ['have_earned'] = 'du har tjänat ~p~%s SEK~s~',
  ['comp_earned'] = '- ditt företag har tjärnat ~p~%s SEK~s~\n- du har tjärnat ~p~%s SEK~s~',
