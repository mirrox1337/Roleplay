Locales['sv'] = {
  ...
  ['vehicleshop_awaiting_model'] = 'Fordonet ~g~LADDAS IN~s~, vänligen vänta!',
  ['confirm_no'] = 'Nej',
  ['confirm_yes'] = 'Ja',
  -- Service
  ...
  ['license_revoked'] = 'Ditt ~g~%s~s~ har blivit ~y~återkallat~s~!',
  ['licence_you_revoked'] = 'Du återkallade ett ~g~%s~s~ som tillhörde ~y~%s~s~',
  ['no_players_nearby'] = 'Det finns ingen i närheten',
  ['being_searched'] = 'Du blir ~y~visiterad~s~ av ~g~Polisen~s~',
  -- Vehicle interaction
  ['vehicle_info'] = 'Fordon',
  ...
  ['search_database_found'] = 'Detta fordon är ~y~registrerat~s~ till ~g~%s~s~',
  -- Traffic interaction
  ...
  ['you_confiscated'] = 'du beslagtog ~y~%sx~s~ ~g~%s~s~ från ~g~%s~s~',
  ['got_confiscated'] = '~y~%sx~s~ ~g~%s~s~ beslagtogs av ~y~%s~s~',
  ['you_confiscated_account'] = 'du beslagtog ~g~%s SEK~s~ (%s) från ~g~%s~s~',
  ['got_confiscated_account'] = '~g~%s SEK~s~ (%s) beslagtogs av ~y~%s~s~',
  ['you_confiscated_weapon'] = 'du beslagtog ~g~%s~s~ från ~g~%s~s~ med ~o~%s~s~ skott',
  ['got_confiscated_weapon'] = 'din ~g~%s~s~ med ~o~%s~s~ skott beslagtogs av ~y~%s~s~',
