Locales['br'] = {
  ...
  ['license_revoked'] = 'your ~p~%s~s~ has been ~y~revoked~s~!',
  ['licence_you_revoked'] = 'you revoked a ~p~%s~s~ which belonged to ~y~%s~s~',
  ...
  ['vehicle_unlocked'] = 'Veículo ~p~destravado~s~',
  ...
  ['search_database_found'] = 'o veículo está ~y~registrado~s~ para ~p~%s~s~',
  -- Traffic interaction
  ...
  ['you_confiscated'] = 'you confiscated ~y~%sx~s~ ~p~%s~s~ from ~p~%s~s~',
  ['got_confiscated'] = '~y~%sx~s~ ~p~%s~s~ were confiscated by ~y~%s~s~',
  ['you_confiscated_account'] = 'you confiscated ~p~$%s~s~ (%s) from ~p~%s~s~',
  ['got_confiscated_account'] = '~p~$%s~s~ (%s) was confiscated by ~y~%s~s~',
  ['you_confiscated_weapon'] = 'you confiscated ~p~%s~s~ from ~p~%s~s~ with ~o~%s~s~ bullets',
  ['got_confiscated_weapon'] = 'your ~p~%s~s~ with ~o~%s~s~ bullets was confiscated by ~y~%s~s~',
  ...
  ['have_withdrawn'] = 'you have withdrawn ~y~%sx~s~ ~p~%s~s~',
  ['have_deposited'] = 'you have deposited ~y~%sx~s~ ~p~%s~s~',
  ['quantity'] = 'quantity',
  ['inventory'] = 'inventory',
