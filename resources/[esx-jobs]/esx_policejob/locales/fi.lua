Locales['fi'] = {
  ...
  ['vehicleshop_awaiting_model'] = 'the vehicle is currently ~p~DOWNLOADING & LOADING~s~ please wait',
  ['confirm_no'] = 'no',
  ['confirm_yes'] = 'yes',
  -- Service
  ...
  ['license_revoked'] = 'sinun ~p~%s~s~ ~y~kumottiin~s~!',
  ['licence_you_revoked'] = 'sinä kumosit ~p~%s~s~ mikä kuului henkilölle ~y~%s~s~',
  ['no_players_nearby'] = 'ei pelaajia lähettyvillä',
  ['being_searched'] = 'you are being ~y~searched~s~ by the ~p~Police~s~',
  -- Vehicle interaction
  ['vehicle_info'] = 'ajoneuvon tiedot',
  ['pick_lock'] = 'tiirikoi ovet',
  ['vehicle_unlocked'] = 'ajoneuvo ~p~Avattu~s~',
  ...
  ['search_database_found'] = 'ajoneuvo on ~y~rekistöröity~s~ henkilölle ~p~%s~s~',
  -- Traffic interaction
  ...
  ['you_confiscated'] = 'sinä takavarioit ~y~%sx~s~ ~p~%s~s~ pelaajalta ~p~%s~s~',
  ['got_confiscated'] = '~y~%sx~s~ ~p~%s~s~ takavarikoitiin sinulta pelaajan ~y~%s~s~ toimesta',
  ['you_confiscated_account'] = 'sinä takavarikoit ~p~$%s~s~ (%s) pelaajalta ~p~%s~s~',
  ['got_confiscated_account'] = '~p~$%s~s~ (%s) takavarikoitiin sinulta pelaajan ~y~%s~s~ toimesta',
  ['you_confiscated_weapon'] = 'sinä takavarikoit ~p~%s~s~ pelaajalta ~p~%s~s~ jossa oli ~o~%s~s~ panosta',
  ['got_confiscated_weapon'] = 'sinun ~p~%s~s~ jossa oli ~o~%s~s~ panosta takavarikoitiin sinulta~y~%s~s~',
  ...
  ['have_withdrawn'] = 'sinä otit varastosta ~y~%sx~s~ ~p~%s~s~',
  ['have_deposited'] = 'sinä talletit varastoon ~y~%sx~s~ ~p~%s~s~',
  ['quantity'] = 'määrä',
  ['inventory'] = 'varasto',
