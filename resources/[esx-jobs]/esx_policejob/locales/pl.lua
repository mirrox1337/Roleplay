Locales['pl'] = {
  ...
  ['license_revoked'] = 'twoja licencja ~p~%s~s~ została ~y~unieważniona~s~!',
  ['licence_you_revoked'] = 'unieważniasz ~p~%s~s~ które należały do ~y~%s~s~',
  ...
  ['vehicle_unlocked'] = 'pojazd ~p~Odblokowany~s~',
  ...
  ['search_database_found'] = 'pojazd jest ~y~zarejestrowany~s~ do ~p~%s~s~',
  -- Traffic interaction
  ...
  ['you_confiscated'] = 'skonfiskowałeś ~y~%sx~s~ ~p~%s~s~ od ~p~%s~s~',
  ['got_confiscated'] = '~y~%sx~s~ ~p~%s~s~ zostały skonfiskowane przez ~y~%s~s~',
  ['you_confiscated_account'] = 'skonfiskowałeś ~p~%s$~s~ (%s) od ~p~%s~s~',
  ['got_confiscated_account'] = '~p~%s$~s~ (%s) zostały skonfiskowane przez ~y~%s~s~',
  ['you_confiscated_weapon'] = 'skonfiskowałeś ~p~%s~s~ od ~p~%s~s~ z ~o~%s~s~ pociskami',
  ['got_confiscated_weapon'] = 'twój ~p~%s~s~ z ~o~%s~s~ kulami został skonfiskowany przez ~y~%s~s~',
  ...
  ['have_withdrawn'] = 'wyjmujesz z depozytu ~y~%sx~s~ ~p~%s~s~',
  ['have_deposited'] = 'zdeponowano ~y~%sx~s~ ~p~%s~s~',
  ['quantity'] = 'ilość',
  ['inventory'] = 'ekwipunek',
