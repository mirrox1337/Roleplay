Locales['fr'] = {
  ...
  ['vehicleshop_awaiting_model'] = 'le véhicule est actuellement en ~p~PRÉPARATION~s~ veuillez patienter',
  ['confirm_no'] = 'non',
  ['confirm_yes'] = 'oui',
  -- Service
  ...
  ['license_revoked'] = 'votre ~p~%s~s~ a été ~y~révoqué~s~!',
  ['licence_you_revoked'] = 'vous avez révoqué un ~p~%s~s~ qui appartenait à ~y~%s~s~',
  ['no_players_nearby'] = 'aucun joueur à proximité',
  ['being_searched'] = 'vous êtes ~y~recherché(e)~s~ par la ~p~Police~s~',
  -- Vehicle interaction
  ['vehicle_info'] = 'infos véhicule',
  ['pick_lock'] = 'crocheter véhicule',
  ['vehicle_unlocked'] = 'véhicule ~p~déverouillé~s~',
  ...
  ['search_database_found'] = 'le véhicule est ~y~enregistré~s~ à ~p~%s~s~',
  -- Traffic interaction
  ...
  ['you_confiscated'] = 'vous avez confisqué ~y~%sx~s~ ~p~%s~s~ à ~p~%s~s~',
  ['got_confiscated'] = '~y~%sx~s~ ~p~%s~s~ ont été confisqués par ~y~%s~s~',
  ['you_confiscated_account'] = 'vous avez confisqué ~p~$%s~s~ (%s) à ~p~%s~s~',
  ['got_confiscated_account'] = '~p~$%s~s~ (%s) ont été confisqués par ~y~%s~s~',
  ['you_confiscated_weapon'] = 'vous avez confisqué ~p~%s~s~ à ~p~%s~s~ avec ~o~%s~s~ balles',
  ['got_confiscated_weapon'] = 'votre ~p~%s~s~ avec ~o~%s~s~ balles a été confisqué par ~y~%s~s~',
  ...
  ['have_withdrawn'] = 'vous avez retiré ~y~%sx~s~ ~p~%s~s~',
  ['have_deposited'] = 'vous avez déposé ~y~%sx~s~ ~p~%s~s~',
  ['quantity'] = 'quantité',
