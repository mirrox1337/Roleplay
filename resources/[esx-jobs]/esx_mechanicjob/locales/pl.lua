Locales['pl'] = {
  ...
  ['vehicle_success_attached']  = 'pojazd ~g~przyłączony~s~',
  ...
  ['veh_det_succ']              = 'pojazd ~g~odłączony~s~!',
  ['imp_flatbed']               = '~r~Akcja niemożliwa!~s~ Potrzebujesz ~g~lawety~s~ aby załadować pojazd',
  ['objects']                   = 'objekty',
  ['roadcone']                  = 'pachołek',
  ...
  ['recovery_gas_can']          = 'odzyskiwanie ~g~Kanistra z paliwem~s~...',
  ['recovery_repair_tools']     = 'odzyskiwanie ~g~Części naprawczych~s~...',
  ['recovery_body_tools']       = 'odzyskiwanie ~g~Części blacharskich~s~...',
  ['not_enough_gas_can']        = 'nie posiadasz ~r~wystarczająco~s~ paliwa w kanistrze.',
  ['assembling_blowtorch']      = 'składanie ~g~Palnika~s~...',
  ['not_enough_repair_tools']   = 'nie posiadasz ~r~wystarczająco~s~ częsci naprawczych.',
  ['assembling_repair_kit']     = 'składanie ~g~częsci naprawczych~s~...',
  ['not_enough_body_tools']     = 'nie posiadasz ~r~wystarczająco~s~ częsci blacharskich.',
  ['assembling_body_kit']       = 'składanie ~g~częsci blacharskich~s~...',
  ['your_comp_earned']          = 'twoja firma ~g~zarobiła~s~ ~g~$',
  ['you_used_blowtorch']        = 'użyłeś ~g~palnik',
  ['you_used_repair_kit']       = 'użyłeś ~g~częsci naprawczych',
  ['you_used_body_kit']         = 'użyłeś ~g~częsci blacharskich',
  ['have_withdrawn']            = 'wyciągnąłeś ~y~x%s~s~ ~g~%s~s~',
  ['have_deposited']            = 'zdeponowałeś ~y~x%s~s~ ~g~%s~s~',
