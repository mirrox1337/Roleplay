Locales['fr'] = {
  ...
  ['vehicle_success_attached']  = 'vehicule ~g~attaché~s~ avec succès!',
  ...
  ['veh_det_succ']              = 'vehicule ~g~détattaché~s~ avec succès!',
  ['imp_flatbed']               = '~r~Impossible! ~s~Vous devez avoir un ~g~Flatbed ~s~pour ça',
  ['objects']                   = 'objets',
  ['roadcone']                  = 'plot',
  ...
  ['recovery_gas_can']          = 'Récupération de ~g~bouteille de gaz~s~...',
  ['recovery_repair_tools']     = 'Récupération d\'~g~Outils réparation~s~...',
  ['recovery_body_tools']       = 'Récupération d\'~g~Outils carosserie~s~...',
  ['not_enough_gas_can']        = 'Vous n\'avez ~r~pas assez~s~ de bouteille de gaz',
  ['assembling_blowtorch']      = 'Assemblage de ~g~Chalumeaux~s~...',
  ['not_enough_repair_tools']   = 'Vous n\'avez ~r~pas assez~s~ d\'outils réparation',
  ['assembling_blowtorch']      = 'Assemblage de ~g~Kit réparation~s~...',
  ['not_enough_body_tools']     = 'Vous n\'avez ~r~pas assez~s~ d\'outils carosserie',
  ['assembling_body_kit']       = 'Assemblage de ~g~kit carosserie~s~...',
  ...
  ['have_deposited']            = 'vous avez déposé ~y~x%s~s~ ~g~%s~s~',
