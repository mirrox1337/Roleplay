Locales['br'] = {
  ...
  ['vehicle_unlocked']          = 'Veículo ~p~Destrancado',
  ['vehicle_repaired']          = 'Veículo ~p~Reparado',
  ['vehicle_cleaned']           = 'Veículo ~p~Limpo',
  ...
  ['imp_flatbed']               = '~r~Ação impossível!~s~ você precisa de um ~p~reboque de prancha~s~ para isso.',
  ['objects']                   = 'Objetos',
  ['roadcone']                  = 'Cone',
  ...
  ['veh_unlocked']              = '~p~Veículo destrancado',
  ['hijack_failed']             = '~r~Destrava falhou',
  ['body_repaired']             = '~p~Carro reparado',
  ['veh_repaired']              = '~p~Veículo reparado',
  ...
  ['your_comp_earned']          = 'Sua empresa ~p~recebeu~s~ ~p~$',
  ...
  ['have_withdrawn']            = 'você retirou ~y~x%s~s~ ~p~%s~s~',
  ['have_deposited']            = 'você depositou ~y~x%s~s~ ~p~%s~s~',
