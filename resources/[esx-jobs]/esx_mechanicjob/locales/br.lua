Locales['br'] = {
  ...
  ['vehicle_success_attached']  = 'Veículo foi ~g~rebocado~s~ com sucesso!.',
  ...
  ['veh_det_succ']              = 'Veículo foi ~g~entregue~s~ com sucesso...',
  ['imp_flatbed']               = '~r~Ação impossível!~s~ você precisa de um ~g~reboque de prancha~s~ para isso.',
  ['objects']                   = 'Objetos',
  ['roadcone']                  = 'Cone',
  ...
  ['recovery_gas_can']          = '~g~Lata de gâs~s~ fabricado...',
  ['recovery_repair_tools']     = '~g~Ferramentas de reparo~s~ fabricado...',
  ['recovery_body_tools']       = '~g~Ferramentas de capo~s~ fabricado...',
  ['not_enough_gas_can']        = 'Você não tem ~r~lata de gás ~s~ o suficiente.',
  ['assembling_blowtorch']      = 'Montagem ~g~Maçarico~s~...',
  ['not_enough_repair_tools']   = 'Você não tem ~r~ferramentas de reparo~s~ o suficiente.',
  ['assembling_repair_kit']     = 'Fabricando ~g~Kit de reparação~s~...',
  ['not_enough_body_tools']     = 'Você não tem ~r~ferramentas corporais~s~ o suficiente.',
  ['assembling_body_kit']       = 'Fabricando ~g~Kit de corpo~s~...',
  ['your_comp_earned']          = 'Sua empresa ~g~recebeu~s~ ~g~$',
  ['you_used_blowtorch']        = 'Você usou um ~g~maçarico',
  ['you_used_repair_kit']       = 'Você usou um ~g~Kit de reparação',
  ['you_used_body_kit']         = 'Você usou um ~g~Kit de corpo',
  ['have_withdrawn']            = 'você retirou ~y~x%s~s~ ~g~%s~s~',
  ['have_deposited']            = 'você depositou ~y~x%s~s~ ~g~%s~s~',
