Locales['en'] = {
  ...
  ['vehicle_success_attached']  = 'vehicle successfully ~g~attached~s~',
  ...
  ['veh_det_succ']              = 'vehicle successfully ~g~dettached~s~!',
  ['imp_flatbed']               = '~r~Action impossible!~s~ You need a ~g~Flatbed~s~ to load a vehicle',
  ['objects']                   = 'objects',
  ['roadcone']                  = 'roadcone',
  ['toolbox']                   = 'toolbox',
  ...
  ['have_withdrawn']            = 'you have withdrawn ~y~x%s~s~ ~g~%s~s~',
  ['have_deposited']            = 'you have deposited ~y~x%s~s~ ~g~%s~s~',
