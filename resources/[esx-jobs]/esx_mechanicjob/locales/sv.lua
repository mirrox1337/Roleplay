Locales['sv'] = {
  ...
  ['vehicle_success_attached']  = 'fordonet är ~g~bundet~s~!',
  ...
  ['veh_det_succ']              = 'fordonet har ~g~lossnat~s~!',
  ['imp_flatbed']               = '~r~Det går inte!~s~ Du måste ha en ~g~Flatbed~s~ för det!',
  ['objects']                   = 'objekt',
  ['roadcone']                  = 'kona',
  ...
  ['recovery_gas_can']          = '~g~Gasbehållare~s~ återvinns...',
  ['recovery_repair_tools']     = '~g~Reparationsverktyg~s~ återvinns...',
  ['recovery_body_tools']       = '~g~Karossverktyg~s~ återvinns...',
  ['not_enough_gas_can']        = 'Du har ~r~inte tillräckligt~s~ många gasbehållare!',
  ['assembling_blowtorch']      = 'Tillverkar ~g~blåslampa~s~...',
  ['not_enough_repair_tools']   = 'Du har ~r~inte tillräckligt~s~ många reparationsverktyg!',
  ['assembling_repair_kit']     = 'Tillverkar ~g~reparationssats~s~...',
  ['not_enough_body_tools']     = 'Du har ~r~inte tillräckligt~s~ många karossverktyg!',
  ['assembling_body_kit']       = 'Tillverkar ~g~karossverktyg~s~...',
  ['your_comp_earned']          = 'ditt företag har ~g~tjänat~s~ ~g~$',
  ['you_used_blowtorch']        = 'du har använt en ~g~blåslampa~s~',
  ['you_used_repair_kit']       = 'du har använt en ~g~reparationssats~s~',
  ['you_used_body_kit']         = 'du har använt en ~g~karossverktyg~s~',
  ['have_withdrawn']            = 'du har tagit ut ~y~x%s~s~ ~g~%s~s~',
  ['have_deposited']            = 'du har lagrat ~y~x%s~s~ ~g~%s~s~',
