Locales['fi'] = {
  ...
  ['vehicle_success_attached']  = 'ajoneuvo onnistuneesti ~g~kytketty~s~!.',
  ...
  ['veh_det_succ']              = 'ajoneuvo onnistuunesti ~g~irroitettu~s~!',
  ['imp_flatbed']               = '~r~Toiminto mahdoton!~s~ Sinulla pitää olla ~g~Flatbed~s~ tähän.',
  ['objects']                   = 'objektit',
  ['roadcone']                  = 'kartio',
  ...
  ['recovery_gas_can']          = '~g~Kaasupullon~s~ täyttö menossa...',
  ['recovery_repair_tools']     = '~g~Korjaustyökalujen~s~ kerääminen menossa...',
  ['recovery_body_tools']       = '~g~Korin työkalujen~s~ kerääminen menossa...',
  ['not_enough_gas_can']        = 'sinulla ~r~ei ole tarpeeksi~s~ kaasupulloja.',
  ['assembling_blowtorch']      = 'kasataan ~g~Polttoleikkuria~s~...',
  ['not_enough_repair_tools']   = 'sinulla ~r~ei ole tarpeeksi~s~ korjaus työkaluja.',
  ['assembling_repair_kit']     = 'kasataan ~g~Korjauskittiä~s~...',
  ['not_enough_body_tools']     = 'sinulla ~r~ei ole tarpeeksi~s~ kori työkaluja.',
  ['assembling_body_kit']       = 'kasataan ~g~Korikittiä~s~...',
  ['your_comp_earned']          = 'yrityksesi ~g~tienasi~s~ ~g~$',
  ['you_used_blowtorch']        = 'sinä käytit yhden ~g~Polttoleikkurin',
  ['you_used_repair_kit']       = 'sinä käytit yhden ~g~Korjauskitin',
  ['you_used_body_kit']         = 'sinä käytit yhden ~g~Korikitin',
  ['have_withdrawn']            = 'sinä nostit ~y~x%s~s~ ~g~%s~s~',
  ['have_deposited']            = 'sinä talletit ~y~x%s~s~ ~g~%s~s~',
