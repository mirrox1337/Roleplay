Locales['fi'] = {
  ...
  ['vehicle_unlocked']          = 'ajoneuvo ~p~Avattu',
  ['vehicle_repaired']          = 'ajoneuvo ~p~Korjattu',
  ['vehicle_cleaned']           = 'ajoneuvo ~p~pesty',
  ...
  ['imp_flatbed']               = '~r~Toiminto mahdoton!~s~ Sinulla pitää olla ~p~Flatbed~s~ tähän.',
  ['objects']                   = 'objektit',
  ['roadcone']                  = 'kartio',
  ...
  ['inventory']                 = 'reppu',
  ['veh_unlocked']              = '~p~Ajoneuvo avattu',
  ['hijack_failed']             = '~r~Tiirikointi epäonnistu',
  ['body_repaired']             = '~p~Kori korjattu',
  ['veh_repaired']              = '~p~Ajoneuvo korjattu',
  ...
  ['your_comp_earned']          = 'yrityksesi ~p~tienasi~s~ ~p~$',
  ...
  ['have_withdrawn']            = 'sinä nostit ~y~x%s~s~ ~p~%s~s~',
