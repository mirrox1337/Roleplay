...
$(document).ready(function(){
  ...
  function postApplication() {
	...
	$.post('http://esx_joblisting2/postApplication', JSON.stringify({phone : _phone, mail : _mail, exp : _exp, licenses : _licenses, type : _type}));
	emptyEditor();
