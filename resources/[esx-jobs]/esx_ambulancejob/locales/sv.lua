Locales['sv'] = {
  ...
  -- Vehicles
  ['ambulance'] = 'ambulance',
  ['helicopter_prompt'] = 'Tryck ~INPUT_CONTEXT~ för ~y~Helikopter åtgärder~s~.',
  ...
  ['garage_prompt'] = 'Tryck ~INPUT_CONTEXT~ för ~y~fordons åtgärder~s~.',
  ['garage_title'] = 'Fordons åtgärder',
  ...
  ['garage_storeitem'] = 'Ställ in i garaget',
  ['garage_buyitem'] = 'Fordonsbutik',
  ['shop_item'] = '%s SEK',
  ['vehicleshop_title'] = 'Fordonsbutik',
  ['vehicleshop_confirm'] = 'Vill du beställla fordonet?',
  ['vehicleshop_bought'] = 'Du har beställt en %s för $%s',
