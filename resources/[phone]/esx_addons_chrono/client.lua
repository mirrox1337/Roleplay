...
Citizen.CreateThread(function()
  ...
  while true do
    ...
    if #alerts ~= 0 then
      ...
      SetTextColour(255, 255, 255, 255)
      SetTextEntry("STRING")
      AddTextComponentString('Tryck ~p~ PGUP ~s~ för att ta samtalet - Tryck ~r~ PGDOWN ~s~ för att kryssa ner')
      DrawText(0.025, 0.16)
      ...
      if alert.coords ~= nil then
        ...
        SetTextColour(255, 255, 255, 255)
        SetTextEntry("STRING")
        AddTextComponentString('~p~Position: ~p~' .. math.floor(alert.coords.x) .. ' ' .. math.floor(alert.coords.y))
        DrawText(0.07, 0.14)
      else
        SetTextFont(0)
        SetTextScale(0.0, 0.24)
      ...
      if alert.numero ~= nil then
        ...
        --AddTextComponentString('~p~Nummer: ~p~' .. alert.numero)
        DrawText(0.17, 0.14)
      else 
        SetTextFont(0)
        SetTextScale(0.0, 0.24)
