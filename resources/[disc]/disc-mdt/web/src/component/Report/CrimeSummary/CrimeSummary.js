      ...
      <Grid item xs={12}>
        <Paper className={classes.tablePaper}>
          <Table className={classes.table} size="small" aria-label="a dense table">
            <TableBody>
              <TableRow><TableCell>Total Bötessumma</TableCell><TableCell>${fines}</TableCell></TableRow>
              <TableRow><TableCell>Total Fängelsetid</TableCell><TableCell>{jail} Månader</TableCell></TableRow>
