      ...
      <Grid item xs={6}>
        <Paper className={classes.tablePaper}>
          <Table className={classes.table} size="small" aria-label="a dense table">
            <TableBody>
              <TableRow><TableCell>Födelsedaturm</TableCell><TableCell>{props.data.dateofbirth}</TableCell></TableRow>
              <TableRow><TableCell>Längd</TableCell><TableCell>{props.data.height} cm</TableCell></TableRow>
              <TableRow><TableCell>Kön</TableCell><TableCell>{props.data.sex === 'm' ? 'M' : 'K'}</TableCell></TableRow>
            </TableBody>
          </Table>
        </Paper>
      </Grid>
