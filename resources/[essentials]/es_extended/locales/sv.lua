Locales['sv'] = {
  ...
  ['gave_item'] = 'du gav ~y~%sx~s~ ~g~%s~s~ till ~y~%s~s~',
  ['received_item'] = 'du tog emot ~y~%sx~s~ ~g~%s~s~ från ~g~%s~s~',
  ['gave_weapon'] = 'du gav ~g~%s~s~ till ~y~%s~s~',
  ['gave_weapon_ammo'] = 'du gav ~o~%sx~s~ skott för ~g~%s~s~ till ~y~%s~s~',
  ['gave_weapon_withammo'] = 'du gav ~g~%s~s~ med ~o~%sx~s~ skott till ~y~%s~s~',
  ['gave_weapon_hasalready'] = '~y~%s~s~ har redan en ~y~%s~s~',
  ['gave_weapon_noweapon'] = '~y~%s~s~ har inte det vapnet',
  ['received_weapon'] = 'du tog emot ~g~%s~s~ från ~g~%s~s~',
  ['received_weapon_ammo'] = 'du tog emot ~o~%sx~s~ skott för ~g~%s~s~ från ~g~%s~s~',
  ['received_weapon_withammo'] = 'du tog emot ~g~%s~s~ med ~o~%sx~s~ skott från ~g~%s~s~',
  ['received_weapon_hasalready'] = '~g~%s~s~ försökte ge dig en ~y~%s~s~, men det har du redan',
  ['received_weapon_noweapon'] = '~g~%s~s~ försökte ge dig ammunition för ett ~y~%s~s~, men du har inget sådant vapen',
  ['gave_money'] = 'du gav ~g~%s SEK~s~ till ~y~%s~s~',
  ['received_money'] = 'du tog emot ~g~%s SEK~s~ från ~g~%s~s~',
  ['gave_account_money'] = 'du gav ~g~%s SEK~s~ (%s) till ~y~%s~s~',
  ['received_account_money'] = 'du tog emot ~g~%s SEK~s~ (%s) från ~g~%s~s~',
  ...
  ['threw_standard'] = 'du kastade ~y~%sx~s~ ~g~%s~s~',
  ['threw_money'] = 'du kastade ~r~$%s~s~ ~g~kontanter~s~',
  ['threw_account'] = 'du kastade ~r~$%s~s~ ~g~%s~s~',
  ['threw_weapon'] = 'du kastade ~g~%s~s~',
  ['threw_weapon_ammo'] = 'du kastade ~g~%s~s~ med ~o~%sx~s~ skott',
  -- Salary related
  ...
  ['weapon_dagger'] = 'dolk',
  ['weapon_vintagepistol'] = 'Laserpistol',
