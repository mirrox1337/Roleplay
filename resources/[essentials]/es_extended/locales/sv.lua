Locales['sv'] = {
  ...
  ['gave_item'] = 'du gav ~y~%sx~s~ ~p~%s~s~ till ~y~%s~s~',
  ['received_item'] = 'du tog emot ~y~%sx~s~ ~p~%s~s~ från ~p~%s~s~',
  ['gave_weapon'] = 'du gav ~p~%s~s~ till ~y~%s~s~',
  ['gave_weapon_ammo'] = 'du gav ~o~%sx~s~ skott för ~p~%s~s~ till ~y~%s~s~',
  ['gave_weapon_withammo'] = 'du gav ~p~%s~s~ med ~o~%sx~s~ skott till ~y~%s~s~',
  ['gave_weapon_hasalready'] = '~y~%s~s~ har redan en ~y~%s~s~',
  ['gave_weapon_noweapon'] = '~y~%s~s~ har inte det vapnet',
  ['received_weapon'] = 'du tog emot ~p~%s~s~ från ~p~%s~s~',
  ['received_weapon_ammo'] = 'du tog emot ~o~%sx~s~ skott för ~p~%s~s~ från ~p~%s~s~',
  ['received_weapon_withammo'] = 'du tog emot ~p~%s~s~ med ~o~%sx~s~ skott från ~p~%s~s~',
  ['received_weapon_hasalready'] = '~p~%s~s~ försökte ge dig en ~y~%s~s~, men det har du redan',
  ['received_weapon_noweapon'] = '~p~%s~s~ försökte ge dig ammunition för ett ~y~%s~s~, men du har inget sådant vapen',
  ['gave_money'] = 'du gav ~p~%s SEK~s~ till ~y~%s~s~',
  ['received_money'] = 'du tog emot ~p~%s SEK~s~ från ~p~%s~s~',
  ['gave_account_money'] = 'du gav ~p~%s SEK~s~ (%s) till ~y~%s~s~',
  ['received_account_money'] = 'du tog emot ~p~%s SEK~s~ (%s) från ~p~%s~s~',
  ...
  ['threw_standard'] = 'du kastade ~y~%sx~s~ ~p~%s~s~',
  ['threw_money'] = 'du kastade ~r~$%s~s~ ~p~kontanter~s~',
  ['threw_account'] = 'du kastade ~r~$%s~s~ ~p~%s~s~',
  ['threw_weapon'] = 'du kastade ~p~%s~s~',
  ['threw_weapon_ammo'] = 'du kastade ~p~%s~s~ med ~o~%sx~s~ skott',
  -- Salary related
  ['received_salary'] = 'du har mottagit din lön på ~p~%s SEK~s~',
  ['received_help'] = 'du har mottagit bidrag på ~p~%s SEK~s~',
  ...
  ['money_set'] = 'någon ~y~högt uppsatt~s~ satte ~p~%s SEK~s~ (%s) för dig!',
