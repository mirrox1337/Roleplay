Locales['br'] = {
  ...
  ['gave_item'] = 'voce deu ~y~%sx~s~ ~g~%s~s~ para ~y~%s~s~',
  ['received_item'] = 'voce recebeu ~y~%sx~s~ ~g~%s~s~ de ~g~%s~s~',
  ...
  ['received_money'] = 'voce recebeu ~g~$%s~s~ de ~g~%s~s~',
  ['gave_account_money'] = 'voce deu ~g~$%s~s~ (%s) para ~y~%s~s~',
  ['received_account_money'] = 'voce recebeu ~g~$%s~s~ (%s) de ~g~%s~s~',
