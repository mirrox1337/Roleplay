Locales['cs'] = {
  ...
  ['gave_item'] = 'dali jste ~y~%sx~s~ ~g~%s~s~ ~y~%s~s~',
  ['received_item'] = 'obdrželi jste ~y~%sx~s~ ~g~%s~s~ od ~g~%s~s~',
  ...
  ['received_money'] = 'obdrželi jste ~g~$%s~s~ od ~g~%s~s~',
  ['gave_account_money'] = 'dali jste ~g~$%s~s~ (%s) ~y~%s~s~',
  ['received_account_money'] = 'obdrželi jste ~g~$%s~s~ (%s) od ~g~%s~s~',
