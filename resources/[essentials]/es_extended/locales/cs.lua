Locales['cs'] = {
  ...
  ['gave_item'] = 'dali jste ~y~%sx~s~ ~p~%s~s~ ~y~%s~s~',
  ['received_item'] = 'obdrželi jste ~y~%sx~s~ ~p~%s~s~ od ~p~%s~s~',
  ...
  ['gave_money'] = 'dali jste ~p~$%s~s~ ~y~%s~s~',
  ['received_money'] = 'obdrželi jste ~p~$%s~s~ od ~p~%s~s~',
  ['gave_account_money'] = 'dali jste ~p~$%s~s~ (%s) ~y~%s~s~',
  ['received_account_money'] = 'obdrželi jste ~p~$%s~s~ (%s) od ~p~%s~s~',
  ...
  -- Salary related
  ['received_salary'] = 'obdrželi jste výplatu: ~p~$%s~s~',
  ['received_help'] = 'obdrželi jste sociální dávku: ~p~$%s~s~',
  ...
  ['money_set'] = 'někdo s ~y~vysokou úrovní~s~ vám právě nastavil ~p~$%s~s~ (%s)!',
