Locales['en'] = {
  ...
  ['gave_item'] = 'you gave ~y~%sx~s~ ~p~%s~s~ to ~y~%s~s~',
  ['received_item'] = 'you received ~y~%sx~s~ ~p~%s~s~ from ~p~%s~s~',
  ...
  ['gave_money'] = 'you gave ~p~$%s~s~ to ~y~%s~s~',
  ['received_money'] = 'you received ~p~$%s~s~ from ~p~%s~s~',
  ['gave_account_money'] = 'you gave ~p~$%s~s~ (%s) to ~y~%s~s~',
  ['received_account_money'] = 'you received ~p~$%s~s~ (%s) from ~p~%s~s~',
  ...
  -- Salary related
  ['received_salary'] = 'you received your salary: ~p~$%s~s~',
  ['received_help'] = 'you recieved your welfare check: ~p~$%s~s~',
