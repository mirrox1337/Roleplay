Locales['en'] = {
  ...
  ['gave_item'] = 'you gave ~y~%sx~s~ ~g~%s~s~ to ~y~%s~s~',
  ['received_item'] = 'you received ~y~%sx~s~ ~g~%s~s~ from ~g~%s~s~',
  ['gave_weapon'] = 'you gave ~g~%s~s~ to ~y~%s~s~',
  ['gave_weapon_ammo'] = 'you gave ~o~%sx~s~ bullets for ~g~%s~s~ to ~y~%s~s~',
  ['gave_weapon_withammo'] = 'you gave ~g~%s~s~ with ~o~%sx~s~ bullets to ~y~%s~s~',
  ['gave_weapon_hasalready'] = '~y~%s~s~ already have an ~y~%s~s~',
  ['gave_weapon_noweapon'] = '~y~%s~s~ does not have that weapon',
  ['received_weapon'] = 'you received ~g~%s~s~ from ~g~%s~s~',
  ['received_weapon_ammo'] = 'you received ~o~%sx~s~ bullets for your ~g~%s~s~ from ~g~%s~s~',
  ['received_weapon_withammo'] = 'you received ~g~%s~s~ with ~o~%sx~s~ bullets from ~g~%s~s~',
  ...
  ['received_money'] = 'you received ~g~$%s~s~ from ~g~%s~s~',
  ['gave_account_money'] = 'you gave ~g~$%s~s~ (%s) to ~y~%s~s~',
  ['received_account_money'] = 'you received ~g~$%s~s~ (%s) from ~g~%s~s~',
  ...
  ['threw_weapon'] = 'you threw ~g~%s~s~',
  ['threw_weapon_ammo'] = 'you threw ~g~%s~s~ with ~o~%sx~s~ bullets',
  -- Salary related
