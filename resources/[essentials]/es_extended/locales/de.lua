Locales['de'] = {
  ...
  ['gave_item'] = 'du gibst ~y~%sx~s~ ~g~%s~s~ an ~y~%s~s~',
  ['received_item'] = 'du empfängst ~y~%sx~s~ ~g~%s~s~ von ~g~%s~s~',
  ['gave_weapon'] = 'du gibst ~g~%s~s~ an ~y~%s~s~',
  ['gave_weapon_ammo'] = 'you gave ~o~%sx~s~ bullets for ~g~%s~s~ to ~y~%s~s~',
  ['gave_weapon_withammo'] = 'du gibst ~g~%s~s~ mit ~o~%sx~s~ Schuss an ~y~%s~s~',
  ['gave_weapon_hasalready'] = '~y~%s~s~ hat bereits eine(n) ~y~%s~s~',
  ['gave_weapon_noweapon'] = '~y~%s~s~ does not have that weapon',
  ['received_weapon'] = 'du erhälst ~g~%s~s~ von ~g~%s~s~',
  ['received_weapon_ammo'] = 'you received ~o~%sx~s~ bullets for your ~g~%s~s~ from ~g~%s~s~',
  ['received_weapon_withammo'] = 'du erhälst ~g~%s~s~ mit ~o~%sx~s~ Schuss von ~g~%s~s~',
  ['received_weapon_hasalready'] = '~g~%s~s~ hat versucht dir eine(n) ~y~%s~s~ zu geben, aber du hast bereits eine(n)',
  ...
  ['received_money'] = 'du erhälst ~g~$%s~s~ von ~g~%s~s~',
  ['gave_account_money'] = 'du gibst ~g~$%s~s~ (%s) an ~y~%s~s~',
  ['received_account_money'] = 'du empfängst ~g~$%s~s~ (%s) von ~g~%s~s~',
