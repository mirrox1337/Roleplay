Locales['fi'] = {
  ...
  ['gave_item'] = 'sinä annoit ~y~%sx~s~ ~g~%s~s~ henkilölle ~y~%s~s~',
  ['received_item'] = 'sinä sait ~y~%sx~s~ ~g~%s~s~ henkilöltä ~g~%s~s~',
  ['gave_weapon'] = 'you gave ~y~1x~s~ ~g~%s~s~ to ~y~%s~s~',
  ['gave_weapon_ammo'] = 'you gave ~o~%sx~s~ bullets for ~g~%s~s~ to ~y~%s~s~',
  ['gave_weapon_withammo'] = 'you gave ~y~1x~s~ ~g~%s~s~ with ~o~%sx~s~ bullets to ~y~%s~s~',
  ['gave_weapon_hasalready'] = '~y~%s~s~ already have an ~y~%s~s~',
  ['gave_weapon_noweapon'] = '~y~%s~s~ does not have that weapon',
  ['received_weapon'] = 'you received ~y~1x~s~ ~g~%s~s~ from ~g~%s~s~',
  ['received_weapon_ammo'] = 'you received ~o~%sx~s~ bullets for your ~g~%s~s~ from ~g~%s~s~',
  ['received_weapon_withammo'] = 'you received ~y~1x~s~ ~g~%s~s~ with ~o~%sx~s~ bullets from ~g~%s~s~',
  ['received_weapon_hasalready'] = '~g~%s~s~ attempted to give you an ~y~%s~s~, but you already have one',
  ['received_weapon_noweapon'] = '~g~%s~s~ attempted to give you ammo for an ~y~%s~s~, but you dont have one',
  ['gave_money'] = 'sinä annoit ~g~$%s~s~ henkilölle ~y~%s~s~',
  ['received_money'] = 'sinä sait ~g~$%s~s~ henkilöltä ~g~%s~s~',
  ['gave_account_money'] = 'sinä annoit ~g~$%s~s~ (%s) henkilölle ~y~%s~s~',
  ['received_account_money'] = 'sinä sait ~g~$%s~s~ (%s) henkilöltä ~g~%s~s~',
  ...
  ['threw_standard'] = 'you threw ~y~%sx~s~ ~g~%s~s~',
  ['threw_money'] = 'you threw ~r~$%s~s~ ~g~cash~s~',
  ['threw_account'] = 'you threw ~r~$%s~s~ ~g~%s~s~',
  ['threw_weapon'] = 'you threw ~y~1x~s~ ~g~%s~s~',
  ['threw_weapon_ammo'] = 'you threw ~y~1x~s~ ~g~%s~s~ with ~o~%sx~s~ bullets',
  -- Salary related
