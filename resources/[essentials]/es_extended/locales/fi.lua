Locales['fi'] = {
  ...
  ['gave_item'] = 'sinä annoit ~y~%sx~s~ ~p~%s~s~ henkilölle ~y~%s~s~',
  ['received_item'] = 'sinä sait ~y~%sx~s~ ~p~%s~s~ henkilöltä ~p~%s~s~',
  ['gave_weapon'] = 'you gave ~y~1x~s~ ~p~%s~s~ to ~y~%s~s~',
  ['gave_weapon_ammo'] = 'you gave ~o~%sx~s~ bullets for ~p~%s~s~ to ~y~%s~s~',
  ['gave_weapon_withammo'] = 'you gave ~y~1x~s~ ~p~%s~s~ with ~o~%sx~s~ bullets to ~y~%s~s~',
  ['gave_weapon_hasalready'] = '~y~%s~s~ already have an ~y~%s~s~',
  ['gave_weapon_noweapon'] = '~y~%s~s~ does not have that weapon',
  ['received_weapon'] = 'you received ~y~1x~s~ ~p~%s~s~ from ~p~%s~s~',
  ['received_weapon_ammo'] = 'you received ~o~%sx~s~ bullets for your ~p~%s~s~ from ~p~%s~s~',
  ['received_weapon_withammo'] = 'you received ~y~1x~s~ ~p~%s~s~ with ~o~%sx~s~ bullets from ~p~%s~s~',
  ['received_weapon_hasalready'] = '~p~%s~s~ attempted to give you an ~y~%s~s~, but you already have one',
  ['received_weapon_noweapon'] = '~p~%s~s~ attempted to give you ammo for an ~y~%s~s~, but you dont have one',
  ['gave_money'] = 'sinä annoit ~p~$%s~s~ henkilölle ~y~%s~s~',
  ['received_money'] = 'sinä sait ~p~$%s~s~ henkilöltä ~p~%s~s~',
  ['gave_account_money'] = 'sinä annoit ~p~$%s~s~ (%s) henkilölle ~y~%s~s~',
  ['received_account_money'] = 'sinä sait ~p~$%s~s~ (%s) henkilöltä ~p~%s~s~',
  ...
  ['threw_standard'] = 'you threw ~y~%sx~s~ ~p~%s~s~',
  ['threw_money'] = 'you threw ~r~$%s~s~ ~p~cash~s~',
  ['threw_account'] = 'you threw ~r~$%s~s~ ~p~%s~s~',
  ['threw_weapon'] = 'you threw ~y~1x~s~ ~p~%s~s~',
  ['threw_weapon_ammo'] = 'you threw ~y~1x~s~ ~p~%s~s~ with ~o~%sx~s~ bullets',
  -- Salary related
  ['received_salary'] = 'sinä vastaanotit palkkaa: ~p~$%s~s~',
  ['received_help'] = 'sinä vastaanotit valtion tukea: ~p~$%s~s~',
  ...
  ['money_set'] = 'joku ~y~korkeesti rankattu~s~ asetti ~p~$%s~s~ (%s) sinulle!',
