Locales['pl'] = {
  ...
  ['gave_item'] = 'dajesz ~y~%sx~s~ ~p~%s~s~ dla ~y~%s~s~',
  ['received_item'] = 'otrzymujesz ~y~%sx~s~ ~p~%s~s~ od ~p~%s~s~',
  ['gave_weapon'] = 'dajesz ~p~%s~s~ dla ~y~%s~s~',
  ['gave_weapon_ammo'] = 'dałeś/aś ~o~%sx~s~ naboi do ~p~%s~s~ dla ~y~%s~s~',
  ['gave_weapon_withammo'] = 'dałeś/aś ~p~%s~s~ z ~o~%sx~s~ nabojami dla ~y~%s~s~',
  ['gave_weapon_hasalready'] = '~y~%s~s~ już posiada ~y~%s~s~',
  ['gave_weapon_noweapon'] = '~y~%s~s~ nie posiada tej broni',
  ['received_weapon'] = 'otrzymałeś/aś ~p~%s~s~ od ~p~%s~s~',
  ['received_weapon_ammo'] = 'otrzymałeś/aś ~o~%sx~s~ naboi do twojego ~p~%s~s~ od ~p~%s~s~',
  ['received_weapon_withammo'] = 'otrzymałeś/aś ~p~%s~s~ z ~o~%sx~s~ nabojami od ~p~%s~s~',
  ['received_weapon_hasalready'] = '~p~%s~s~ próbował/a przekazać ci ~y~%s~s~, lecz już posiadasz jedno',
  ['received_weapon_noweapon'] = '~p~%s~s~ próbował/a przekazać ci amunicje do ~y~%s~s~, lecz nie posiadasz tej broni',
  ['gave_money'] = 'dajesz ~p~%s$~s~ dla ~y~%s~s~',
  ['received_money'] = 'otrzymujesz ~p~%s$~s~ od ~p~%s~s~',
  ['gave_account_money'] = 'dajesz ~p~%s$~s~ (%s) dla ~y~%s~s~',
  ['received_account_money'] = 'otrzymujesz ~p~%s$~s~ (%s) od ~p~%s~s~',
  ...
  ['threw_standard'] = 'wyrzuciłeś/aś ~y~%sx~s~ ~p~%s~s~',
  ['threw_money'] = 'wyrzuciłeś/aś ~r~$%s~s~ ~p~gotówki~s~',
  ['threw_account'] = 'wyrzuciłeś/aś ~r~$%s~s~ ~p~%s~s~',
  ['threw_weapon'] = 'wyrzuciłeś/aś ~p~%s~s~',
  ['threw_weapon_ammo'] = 'wyrzuciłeś/aś ~p~%s~s~ z ~o~%sx~s~ nabojami',
	
  -- Salary related
  ['received_salary'] = 'otrzymałeś wynagrodzenie: ~p~%s$~s~',
  ['received_help'] = 'otrzymałem zapomogę: ~p~$%s~s~',
  ...
  ['money_set'] = 'ktoś ~y~wysoko postawiony~s~ podarował Ci pieniądze i masz teraz ~p~%s$~s~ (%s)!',
