Locales['pl'] = {
  ...
  ['gave_item'] = 'dajesz ~y~%sx~s~ ~g~%s~s~ dla ~y~%s~s~',
  ['received_item'] = 'otrzymujesz ~y~%sx~s~ ~g~%s~s~ od ~g~%s~s~',
  ['gave_weapon'] = 'dajesz ~g~%s~s~ dla ~y~%s~s~',
  ['gave_weapon_ammo'] = 'dałeś/aś ~o~%sx~s~ naboi do ~g~%s~s~ dla ~y~%s~s~',
  ['gave_weapon_withammo'] = 'dałeś/aś ~g~%s~s~ z ~o~%sx~s~ nabojami dla ~y~%s~s~',
  ['gave_weapon_hasalready'] = '~y~%s~s~ już posiada ~y~%s~s~',
  ['gave_weapon_noweapon'] = '~y~%s~s~ nie posiada tej broni',
  ['received_weapon'] = 'otrzymałeś/aś ~g~%s~s~ od ~g~%s~s~',
  ['received_weapon_ammo'] = 'otrzymałeś/aś ~o~%sx~s~ naboi do twojego ~g~%s~s~ od ~g~%s~s~',
  ['received_weapon_withammo'] = 'otrzymałeś/aś ~g~%s~s~ z ~o~%sx~s~ nabojami od ~g~%s~s~',
  ['received_weapon_hasalready'] = '~g~%s~s~ próbował/a przekazać ci ~y~%s~s~, lecz już posiadasz jedno',
  ['received_weapon_noweapon'] = '~g~%s~s~ próbował/a przekazać ci amunicje do ~y~%s~s~, lecz nie posiadasz tej broni',
  ['gave_money'] = 'dajesz ~g~%s$~s~ dla ~y~%s~s~',
  ['received_money'] = 'otrzymujesz ~g~%s$~s~ od ~g~%s~s~',
  ['gave_account_money'] = 'dajesz ~g~%s$~s~ (%s) dla ~y~%s~s~',
  ['received_account_money'] = 'otrzymujesz ~g~%s$~s~ (%s) od ~g~%s~s~',
  ...
  ['threw_standard'] = 'wyrzuciłeś/aś ~y~%sx~s~ ~g~%s~s~',
  ['threw_money'] = 'wyrzuciłeś/aś ~r~$%s~s~ ~g~gotówki~s~',
  ['threw_account'] = 'wyrzuciłeś/aś ~r~$%s~s~ ~g~%s~s~',
  ['threw_weapon'] = 'wyrzuciłeś/aś ~g~%s~s~',
  ['threw_weapon_ammo'] = 'wyrzuciłeś/aś ~g~%s~s~ z ~o~%sx~s~ nabojami',
