Locales['fr'] = {
  ...
  ['gave_item'] = 'vous avez donné ~y~%sx~s~ ~g~%s~s~ à ~y~%s~s~',
  ['received_item'] = 'vous avez reçu ~y~%sx~s~ ~g~%s~s~ par ~g~%s~s~',
  ['gave_weapon'] = 'vous avez donné ~y~1x~s~ ~g~%s~s~ à ~y~%s~s~',
  ['gave_weapon_ammo'] = 'vous avez donné ~o~%sx~s~ balles pour ~g~%s~s~ à ~y~%s~s~',
  ['gave_weapon_withammo'] = 'vous avez donné ~y~1x~s~ ~g~%s~s~ avec ~o~%sx~s~ balles à ~y~%s~s~',
  ['gave_weapon_hasalready'] = '~y~%s~s~ a déjà ~y~%s~s~',
  ['gave_weapon_noweapon'] = '~y~%s~s~ n\'a pas cette arme',
  ['received_weapon'] = 'vous recevez ~y~1x~s~ ~g~%s~s~ de ~g~%s~s~',
  ['received_weapon_ammo'] = 'vous avez reçu ~o~%sx~s~ balles pour votre ~g~%s~s~ de ~g~%s~s~',
  ['received_weapon_withammo'] = 'vous avez reçu ~y~1x~s~ ~g~%s~s~ avec ~o~%sx~s~ balles de ~g~%s~s~',
  ['received_weapon_hasalready'] = '~g~%s~s~ a tenté de vous donner ~y~%s~s~, mais vous en aviez déjà un exemplaire',
  ['received_weapon_noweapon'] = '~g~%s~s~ tente de vous donner des munitions pour ~y~%s~s~, mais vous n\'en avez pas',
  ...
  ['threw_standard'] = 'vous avez jeté ~y~%sx~s~ ~g~%s~s~',
  ['threw_money'] = 'vous avez jeté ~r~$%s~s~ ~g~cash~s~',
  ['threw_account'] = 'vous avez jeté ~r~$%s~s~ ~g~%s~s~',
  ['threw_weapon'] = 'vous avez jeté ~y~1x~s~ ~g~%s~s~',
  ['threw_weapon_ammo'] = 'vous avez jeté ~y~1x~s~ ~g~%s~s~ avec ~o~%sx~s~ balles',
  -- Salary related
