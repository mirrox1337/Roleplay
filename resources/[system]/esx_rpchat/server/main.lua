...
RegisterCommand('me', function(source, args, rawCommand)
    ...
    fal = name.firstname .. " " .. name.lastname
    TriggerClientEvent('chat:addMessage', -1, {
        template = '<div style="padding: 0.5vw;  margin: 0.5vw; background-color: rgba(255, 45, 45, 0.6); border-radius: 3px;"><i class="fas fa-comment-dots"style="font-size:15px;color:white"></i>&ensp;<i><b><font size="3" color="white">{0}:</font></b></i>&ensp;<b><i><font color="white">{1}</font></i></b></div>',
        args = { fal, msg }
    })
end, false)
--[[
