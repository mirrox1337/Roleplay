TokoVoipConfig = {
	...
	plugin_data = {
		...
		localName = " [IN-GAME]", -- If set, this name will be used as the user's teamspeak display name
		localNamePrefix = "Spelare " .. GetPlayerServerId(PlayerId()) .. " |", -- If set, this prefix will be added to the user's teamspeak display name
	}
};
