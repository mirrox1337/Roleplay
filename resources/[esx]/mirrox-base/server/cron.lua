...
RegisterServerEvent('mirrox-base:registerPeriodCron')
AddEventHandler('mirrox-base:registerPeriodCron', function(cron, time)
    if cron == nil then
        cron = function()
...
RegisterServerEvent('mirrox-base:registerTimeCron')
AddEventHandler('mirrox-base:registerTimeCron', function(cron, time)
    local job = {}
