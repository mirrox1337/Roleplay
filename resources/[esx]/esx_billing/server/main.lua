		...
		elseif account == nil then
			...
			if xTarget ~= nil then
				MySQL.Async.execute('INSERT INTO billing (identifier, sender, target_type, target, label, amount) VALUES (@identifier, @sender, @target_type, @target, @label, @amount)',
				{
					...
					TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = _U('received_invoice')})
				end)
			end
			...
			if xTarget ~= nil then
				...
				if xPlayer.getMoney() >= amount then
					...
					MySQL.Async.execute('DELETE from billing WHERE id = @id', {
						...
						TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'success', text = _U('paid_invoice', ESX.Math.GroupDigits(amount))})
				...
				elseif xPlayer.getBank() >= amount then
					...
					TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'error', text = _U('target_no_money')})
