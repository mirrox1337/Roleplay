...
Execute SQL : `mirrox-inventoryhud.sql`

Start using `start mirrox-inventoryhud`
...
- [mirrox-base](https://github.com/DiscworldZA/gta-resources/tree/master/mirrox-base)
