ESX.RegisterServerCallback('mirrox-inventoryhud:UseItemFromSlot', function(source, cb, slot)
...
ESX.RegisterServerCallback('mirrox-inventoryhud:GetItemsInSlotsDisplay', function(source, cb)
    local player = ESX.GetPlayerFromId(source)
    InvType['player'].getInventory(player.identifier, function(inventory)
        local slotItems = {}
        for i = 1, 5, 1 do
