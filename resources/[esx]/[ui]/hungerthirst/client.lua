...
Citizen.CreateThread(function()
    while true do
        ...
        if IsPedInAnyVehicle(PlayerPedId(), false) then
            ...
            drawTxt(UI.Left_x + 0.001 , UI.Bottom_y - 0.217 , 0.58, heading, 0, 119, 119, 255, 8) -- Heading
            ...
            drawTxt(UI.Left_x + 0.001 , UI.Bottom_y - 0.058 , 0.58, heading, 0, 119, 119, 255, 8) -- Heading
