...
Citizen.CreateThread(function()
    TriggerEvent('chat:addSuggestion', '/e', 'Gör emote', {{ name="emotename", help="dance, camera, sit or any valid emote."}})
    TriggerEvent('chat:addSuggestion', '/e', 'Gör emote', {{ name="emotename", help="dance, camera, sit or any valid emote."}})
    TriggerEvent('chat:addSuggestion', '/emote', 'Gör emote', {{ name="emotename", help="dance, camera, sit or any valid emote."}})
