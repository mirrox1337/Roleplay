...
DP.Expressions = {
   ["Arg"] = {"Expression", "mood_angry_1"},
   ["Full"] = {"Expression", "mood_drunk_1"},
   ["Dum"] = {"Expression", "pose_injured_1"},
   ["Elektrisitet"] = {"Expression", "electrocuted_1"},
   ["Vresig"] = {"Expression", "effort_1"},
   ["Vresig2"] = {"Expression", "mood_drivefast_1"},
   ["Vresig3"] = {"Expression", "pose_angry_1"},
   ["Glad"] = {"Expression", "mood_happy_1"},
   ["Skadad"] = {"Expression", "mood_injured_1"},
   ["Upprymd"] = {"Expression", "mood_dancing_low_1"},
   ["Mouthbreather"] = {"Expression", "smoking_hold_1"},
   ["Blinka Aldrig"] = {"Expression", "pose_normal_1"},
   ["Ett Öga"] = {"Expression", "pose_aiming_1"},
   ["Chockad"] = {"Expression", "shocked_1"},
   ["Chockad2"] = {"Expression", "shocked_2"},
   ["Sover"] = {"Expression", "mood_sleeping_1"},
   ["Sover2"] = {"Expression", "dead_1"},
   ["Sover3"] = {"Expression", "dead_2"},
   ["Självbelåten"] = {"Expression", "mood_smug_1"},
   ["Spekulativ"] = {"Expression", "mood_aiming_1"},
   ["Stressad"] = {"Expression", "mood_stressed_1"},
   ["Tjurig"] = {"Expression", "mood_sulk_1"},
   ["Konstig"] = {"Expression", "effort_2"},
   ["Konstig2"] = {"Expression", "effort_3"},
}

DP.Walks = {
  ["Alien"] = {"move_m@alien"},
  ["Armerad"] = {"anim_group_move_ballistic"},
  ...
  ["Självsäker"] = {"move_m@confident"},
  ["Polis"] = {"move_m@business@a"},
  ["Polis2"] = {"move_m@business@b"},
  ["Polis3"] = {"move_m@business@c"},
  ["Standardkvinna"] = {"move_f@multiplayer"},
  ["Standardmann"] = {"move_m@multiplayer"},
  ["Full"] = {"move_m@drunk@a"},
  ["Full"] = {"move_m@drunk@slightlydrunk"},
  ["Full2"] = {"move_m@buzzed"},
  ["Full3"] = {"move_m@drunk@verydrunk"},
  ["Feminin"] = {"move_f@femme@"},
  ...
  ["Vakt"] = {"move_m@prison_gaurd"},
  ["Handfängsel"] = {"move_m@prisoner_cuffed"},
  ["Högklackat"] = {"move_f@heels@c"},
  ["Högklackat2"] = {"move_f@heels@d"},
  ["Hiking"] = {"move_m@hiking"},
  ["Hipster"] = {"move_m@hipster@a"},
  ["Uteliggare"] = {"move_m@hobo@a"},
  ["Bråttom"] = {"move_f@hurry@a"},
  ["Portvakt"] = {"move_p_m_zero_janitor"},
  ["Portvakt2"] = {"move_p_m_zero_slow"},
  ["Jogga"] = {"move_m@jog@"},
  ["Lemar"] = {"anim_group_move_lemar_alley"},
  ["Lester"] = {"move_heist_lester"},
  ["Lester2"] = {"move_lester_caneup"},
  ["Män ätare"] = {"move_f@maneater"},
  ["Michael"] = {"move_ped_bucket"},
  ["Pengar"] = {"move_m@money"},
  ["Muskler"] = {"move_m@muscle@a"},
  ["Elegant"] = {"move_m@posh@"},
  ["Elegant2"] = {"move_f@posh@"},
  ["Snabb"] = {"move_m@quick"},
  ["Springare"] = {"female_fast_runner"},
  ["Ledsen"] = {"move_m@sad@a"},
  ["Kaxig"] = {"move_m@sassy"},
  ["Kaxig2"] = {"move_f@sassy"},
  ["Rädd"] = {"move_f@scared"},
  ["Sexy"] = {"move_f@sexy@a"},
  ["Skum"] = {"move_m@shadyped@a"},
  ["Slö"] = {"move_characters@jimmy@slow@"},
  ["Swagger"] = {"move_m@swagger"},
  ["Tuff"] = {"move_m@tough_guy@"},
  ["Tuff2"] = {"move_f@tough_guy@"},
  ["Soppåse"] = {"clipset@move@trash_fast_turn"},
  ["Soppåse2"] = {"missfbi4prepp1_garbageman"},
  ["Trevor"] = {"move_p_m_two"},
  ["Bred"] = {"move_m@bag"},
...
DP.Shared = {
   ...
   ["skakahand"] = {"mp_ped_interaction", "handshake_guy_a", "Skaka Hand", "skakahand2", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteDuration = 3000,
       SyncOffsetFront = 0.9
   }},
   ["skakahand2"] = {"mp_ped_interaction", "handshake_guy_b", "Skaka Hand 2", "skakahand", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteDuration = 3000
   }},
   ["kram"] = {"mp_ped_interaction", "kisses_guy_a", "Krama", "kram2", AnimationOptions =
   {
       EmoteMoving = false,
       EmoteDuration = 5000,
       SyncOffsetFront = 1.05,
   }},
   ["kram2"] = {"mp_ped_interaction", "kisses_guy_b", "Krama 2", "kram", AnimationOptions =
   {
       EmoteMoving = false,
       EmoteDuration = 5000,
   ...
   ["ge"] = {"mp_common", "givetake1_a", "Ge", "ge2", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteDuration = 2000
   }},
   ["ge2"] = {"mp_common", "givetake1_b", "Ge 2", "ge", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteDuration = 2000
   }},
   ["baseball"] = {"anim@arena@celeb@flat@paired@no_props@", "baseball_a_player_a", "Baseball", "baseballthrow"},
   ["baseballkast"] = {"anim@arena@celeb@flat@paired@no_props@", "baseball_a_player_b", "Baseball Throw", "baseball"},
   ["rån"] = {"random@countryside_gang_fight", "biker_02_stickup_loop", "Råna", "rån", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["rånad"] = {"missminuteman_1ig_2", "handsup_base", "Bli Rånad", "rånad", AnimationOptions =
   {
      EmoteMoving = true,
      EmoteLoop = true,
   }},
   ["slå"] = {"melee@unarmed@streamed_variations", "plyr_takedown_rear_lefthook", "Slå", "Slagen"},
   ["slagen"] = {"melee@unarmed@streamed_variations", "victim_takedown_front_cross_r", "Slagen", "Slå"},
   ["skalla"] = {"melee@unarmed@streamed_variations", "plyr_takedown_front_headbutt", "Skalla", "Skallad"},
   ["skallad"] = {"melee@unarmed@streamed_variations", "victim_takedown_front_headbutt", "Skallad", "Skalla"},
   ["slå2"] = {"melee@unarmed@streamed_variations", "plyr_takedown_front_backslap", "Slå 2", "Slagen 2", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
       EmoteDuration = 2000,
