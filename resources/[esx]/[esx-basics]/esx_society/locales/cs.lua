Locales['cs'] = {
  ...
  ['have_withdrawn']         = 'vybral jsi ~p~$%s~s~',
  ...
  ['yes']                    = 'ano',
  ['you_have']               = 'máš ~p~$%s~s~ čekajících na vyprání~s~ (24h).',
  ['you_have_laundered']     = '~r~Vypral jsi~s~ tvé peníze: ~p~$%s~s~',
  ...
  ['you_have_been_promoted'] = 'byl jsi ~p~povýšen~s~!',
}
