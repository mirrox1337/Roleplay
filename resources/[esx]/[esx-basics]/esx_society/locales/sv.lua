Locales['sv'] = {
  ...
  ['have_withdrawn']         = 'du har tagit ut ~p~%s SEK~s~',
  ...
  ['yes']                    = 'ja',
  ['you_have']               = 'du har ~p~%s SEK~s~ som väntar på ~y~pengartvätt~s~ (24h).',
  ['you_have_laundered']     = 'du har ~r~tvättat~s~ dina pengar: ~p~%s SEK~s~',
  ...
  ['you_have_promoted']      = 'du har befodrat ~y~%s~s~ till ~p~%s~s~',
  ['you_have_been_promoted'] = 'du har blivit ~p~befodrad~s~',
}
