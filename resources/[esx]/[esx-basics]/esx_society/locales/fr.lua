Locales['fr'] = {
  ...
  ['have_withdrawn']         = 'vous avez retiré ~p~$%s~s~',
  ...
  ['yes']                    = 'oui',
  ['you_have']               = 'vous avez ~p~$%s~s~ en attente de ~r~blanchiement~s~ (24h).',
  ['you_have_laundered']     = 'vous avez ~r~blanchi~s~ votre argent : ~p~$%s~s~',
