Locales['en'] = {
  ...
  ['have_withdrawn']         = 'you have withdrawn ~p~$%s~s~',
  ...
  ['yes']                    = 'yes',
  ['you_have']               = 'you have ~p~$%s~s~ waiting in ~y~money laundering~s~ (24h).',
  ['you_have_laundered']     = 'you have ~r~laundered~s~ your money: ~p~$%s~s~',
  ...
  ['you_have_been_promoted'] = 'you have been ~p~promoted~s~!',
}
