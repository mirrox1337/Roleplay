...
Citizen.CreateThread(function()
    while true do
        ...
        if IsInAladdinFiskebutikZone(coords) or IsInDealerZone(coords) or IsInMohammedsLivsZone(coords) or IsInPrisonShopZone(coords) or IsInUrbicusBarZone(coords) or IsInSjukhusZone(coords) or IsInGymZone(coords) then
