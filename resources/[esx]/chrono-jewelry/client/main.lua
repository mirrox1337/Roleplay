...
AddEventHandler('chrono-jewelry:currentlyrobbing', function(robb)
	...
	Citizen.Wait(10000)
	exports['mythic_notify']:SendAlert('inform', 'Larmet gick igång.', 2500, { ['background-color'] = '#bf0c00', ['color'] = '#fff' })
	exports['mythic_notify']:SendAlert('inform', 'Krossa alla glasmontrar.', 2500, { ['background-color'] = '#bf0c00', ['color'] = '#fff' })
