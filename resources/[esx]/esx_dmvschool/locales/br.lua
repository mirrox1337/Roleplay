Locales['br'] = {
  ['you_paid'] = 'você pagou ~p~$%s~s~ para a auto escola',
  ...
  ['good_lets_cont'] = '~p~Boa~s~, vamos continuar.',
  ['stop_look_left'] = '~r~Pare~s~ and look ~y~left~s~. Limite de velocidade: ~y~%s~s~ km/h',
  ['good_turn_right'] = '~p~Boa~s~, vire à direita e siga a em frente',
  ...
  ['passed_test'] = 'você ~p~passou~s~ no teste, parabéns!',
