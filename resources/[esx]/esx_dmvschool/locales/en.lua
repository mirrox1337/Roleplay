Locales['en'] = {
  ['you_paid'] = 'you paid ~p~$%s~s~ to the DMV school',
  ...
  ['good_lets_cont'] = '~p~Good~s~, continue.',
  ['stop_look_left'] = '~r~Stop~s~ and look ~y~left~s~. Speed Limit: ~y~%s~s~ km/h',
  ['good_turn_right'] = '~p~Good~s~, turn right and follow the line',
  ...
  ['passed_test'] = 'you ~p~passed~s~ the test, congratulations!',
