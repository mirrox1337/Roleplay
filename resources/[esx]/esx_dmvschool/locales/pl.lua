Locales['pl'] = {
  ['you_paid'] = 'zapłaciłes ~p~$%s~s~ dla szkoły jazdy.',
  ...
  ['good_lets_cont'] = '~p~Świetnie~s~, kontynuuj.',
  ['stop_look_left'] = '~r~Stop~s~ spójrz w ~y~lewo~s~. Ograniczenie prędkości: ~y~%s~s~ km/h',
  ['good_turn_right'] = '~p~Świetnie~s~, skręć w prawo i podążaj za linią',
  ...
  ['passed_test'] = '~p~Zdałeś~s~ egzamin, gratulacje!',
