...
ESX.RegisterUsableItem('ol', function(source)
	...
	TriggerClientEvent('esx:showNotification', source, _U('used_ol'))
...
ESX.RegisterUsableItem('hembränt', function(source)
	...
	TriggerClientEvent('esx_optionalneeds:onDrink', source)
	TriggerClientEvent('esx:showNotification', source, _U('used_hembränt'))
...
ESX.RegisterUsableItem('redbullvodka', function(source)
	...
	TriggerClientEvent('esx_status:add', source, 'drunk', 250000)
	TriggerClientEvent('esx_optionalneeds:onDrink', source)
	TriggerClientEvent('esx:showNotification', source, _U('used_redbullvodka'))
...
ESX.RegisterUsableItem('rottvin', function(source)
	...
	TriggerClientEvent('esx_status:add', source, 'drunk', 250000)
	TriggerClientEvent('esx_optionalneeds:onDrink', source)
	TriggerClientEvent('esx:showNotification', source, _U('used_rottvin'))
