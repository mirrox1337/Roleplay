...
Citizen.CreateThread(function()
	local maxServerSlots = GetConvarInt('sv_maxclients', 60)
...
RegisterServerEvent("ne-queue:playerKicked")
AddEventHandler("ne-queue:playerKicked", function(src, points)
...
RegisterServerEvent("ne-queue:playerConnected")
AddEventHandler("ne-queue:playerConnected", function()
