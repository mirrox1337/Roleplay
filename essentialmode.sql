...
INSERT IGNORE INTO `disc_inventory` (`id`, `owner`, `type`, `data`) VALUES
	...
	(26, 'steam:110000109c2ddf3', 'player', '{"1":{"count":1,"name":"WEAPON_PISTOL"}}');
...
-- Dumpar data för tabell essentialmode.owned_vehicles: ~6 rows (ungefär)
