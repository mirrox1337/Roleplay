...
INSERT IGNORE INTO `disc_inventory` (`id`, `owner`, `type`, `data`) VALUES
	...
	(26, 'steam:110000109c2ddf3', 'player', '{"13":{"count":1,"name":"phone"},"15":{"count":1,"name":"radio"},"20":{"count":1,"name":"lighter"},"11":{"count":20,"name":"cigarett"}}');
...
-- Dumpar data för tabell essentialmode.vehicles: ~222 rows (ungefär)
